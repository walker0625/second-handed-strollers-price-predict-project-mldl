...
* **프로젝트 성격:** End-to-End 딥러닝 파이프라인 구축 (수집-전처리-학습-서빙)
* **주요 역할:** 데이터 수집(당근마켓), 이미지/텍스트 전처리, CNN 기반 회귀 모델링

<img width="1222" height="713" alt="image" src="https://github.com/user-attachments/assets/1734bf55-7c87-455d-ad6b-f35b71cc8152" />
